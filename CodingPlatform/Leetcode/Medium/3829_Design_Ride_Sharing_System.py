...
rideSharingSystem.matchDriverWithRider(); // returns [-1, -1]
'''
from Common.Tags import DESIGN, QUEUE, SET
...
print(rideSharingSystem.matchDriverWithRider())  # Output: [2, 3]
rideSharingSystem.addDriver(5)
rideSharingSystem.cancelRider(3)
print(rideSharingSystem.matchDriverWithRider())  # Output: [5, 1]
print(rideSharingSystem.matchDriverWithRider())  # Output: [-1, -1]