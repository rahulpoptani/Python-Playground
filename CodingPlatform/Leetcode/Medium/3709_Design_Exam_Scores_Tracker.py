...
from Common.Tags import DESIGN, BINARY_SEARCH, PREFIX_SUM
...
class ExamTracker:
    ...
    def totalScore(self, startTime: int, endTime: int) -> int:
        left = self.lower_bound(startTime)
        right = self.upper_bound(endTime)
...
examTracker.record(1, 98)  # Alice takes a new exam at time 1, scoring 98.
print(examTracker.totalScore(1, 1))  # Between time 1 and time 1, Alice took 1 exam at time 1, scoring 98. The total score is 98.
examTracker.record(5, 99)  # Alice takes a new exam at time 5, scoring 99.
print(examTracker.totalScore(1, 3))  # Between time 1 and time 3, Alice took 1 exam at time 1, scoring 98. The total score is 98.
print(examTracker.totalScore(1, 5))  # Between time 1 and time 5, Alice took 2 exams at time 1 and 5, scoring 98 and 99. The total score is 98 + 99 = 197.
print(examTracker.totalScore(3, 4))  # Alice did not take any exam between time 3 and time 4. Therefore, the answer is 0.
print(examTracker.totalScore(2, 5))  # Between time 2 and time 5, Alice took 1 exam at time 5, scoring 99. The total score is 99.